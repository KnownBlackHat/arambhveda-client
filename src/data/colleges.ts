...
export const colleges: College[] = [
  ...
  },
  {
    ...
    avgPackage: 650000,
    topRecruiters: ["TCS", "Infosys", "Wipro", "Capgemini", "Accenture", "L&T Infotech"],
    infrastructure: ["Computer Labs", "Library", "Sports Ground", "Cafeteria", "Seminar Hall", "Workshops"],
    rating: 4.1,
    description: "Thakur College of Engineering & Technology (TCET) is one of Mumbai's reputed private engineering colleges, known for quality education, strong industry connections, and excellent placement records in IT and core engineering."
  },
  {
    id: 32,
    ...
    type: "Private",
    established: 2021,
    approvals: ["UGC", "AICTE", "Maharashtra State Act"],
    campusArea: 5,
    courses: ["BBA", "MBA", "BDes", "B.Tech", "Film & Media"],
    avgFees: 450000,
    admissionExams: ["University Entrance Test", "CUET", "CAT"],
    highestPackage: 1800000,
    avgPackage: 750000,
    topRecruiters: ["Deloitte", "EY", "Ogilvy", "Dentsu", "Amazon", "Zomato"],
    infrastructure: ["Design Studios", "Innovation Lab", "Library", "Media Lab", "Sports Facilities", "Incubation Center"],
    rating: 4.2,
    description: "Atlas SkillTech University is a new-age private university in Mumbai focused on design thinking, entrepreneurship, and industry-ready skills across management, design, technology, and media programs."
  }
];
