...
import { Plus, Search, Edit, Trash2, Star, ChevronLeft, ChevronRight, RotateCcw } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate("/admin/colleges/new")} className="bg-accent hover:bg-accent/90 text-accent-foreground">
